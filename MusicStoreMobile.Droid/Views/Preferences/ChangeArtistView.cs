...
namespace MusicStoreMobile.Droid.Views.Preferences
{
    ...
    [Register(nameof(ChangeArtistView))]
    public class ChangeArtistView : BaseFragment<ChangeArtistViewModel>
    {
        private EditText nameInput;

        private FocusablePropertyHelper _focusablePropertyHelper;

        protected override int FragmentId => Resource.Layout.ChangeArtistView;

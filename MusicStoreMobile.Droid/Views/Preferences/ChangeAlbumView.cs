...
namespace MusicStoreMobile.Droid.Views.Preferences
{
    ...
    [Register(nameof(ChangeAlbumView))]
    public class ChangeAlbumView : BaseFragment<ChangeAlbumViewModel>
    {
        ...
        protected override int FragmentId => Resource.Layout.ChangeAlbumView;
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            this.CreateBinding(_focusablePropertyHelper)
                        ...
                        .To<ChangeAlbumViewModel>(x => x.FocusName)
                        .OneWay()
                        .Apply();
